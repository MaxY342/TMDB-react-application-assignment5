  ...
  return (
    <div className="group">
      ...
      <div className="fixed top-0 left-0 z-50 flex h-screen w-0 flex-col overflow-hidden whitespace-nowrap bg-gray-800 transition-[width] duration-500 ease-in-out group-hover:w-md">
        <Link to="/">Home</Link>
        <Link match="/movies/category/:listType" to="/movies/category/now_playing">Movies</Link>
        <Link match="/tv/category/:listType" to="/tv/category/airing_today">Tv</Link>
        <Link match="/trending/:mediaType" to="/trending/movies">Trending</Link>
        <Link match="/genre/:mediaType/:genreId" to="/genre/movies/28">Genres</Link>
